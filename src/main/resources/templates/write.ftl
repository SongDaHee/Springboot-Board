...
<div class="back_img">
    <div class="container">
    <form method="post" action="/list/write-proc">
        <fieldset>
            <legend><b>글 작성하기</b></legend>
            ...
            <div class="form-group">
                <label>내용</label>
                <textarea class="form-control" name="input_content" rows="10"></textarea>
            </div>

            <div class="button"><button type="submit" class="btn btn-primary">저장하기</button></div>
